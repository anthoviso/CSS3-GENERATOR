...
// $('body').on('mousedown','mouseup','keyup', function() {
	// console.log("event");
	// });



    // container.innerHTML = " <div id='outputContainer' style=\"background: " + dieze + $('#Background')[0].value +
    // ";color: " + dieze + $('#Color')[0].value +
    // ";font-family: " + $('#FontFamily')[0].value +
    // ";box-sizing: " + $('#BoxSizing')[0].value +
    // ";line-height: " + $('#LineHeight')[0].value +
    ...
    // ";z-index : " + $('#Zindex')[0].value +
    // ";box-sizing : " + $('#BoxSizing')[0].value +
    // ";position : " + $('#Position')[0].value + ";\" >" + textValueForm.value  + "</div>"
